      ...
      <div className={`settings-container ${visible && 'visible-modal'}`}>
        <div className="settings-modal">
            ...
            <div className="option-group">
              ...
              <div className="buttons">
                <button
                  ...
                  className={`option-button ${settings.font === 'serif' && 'option-button-selected'}`}
                >
                  Serif
                </button>
                <button
                  ...
                  className={`option-button ${settings.font === 'sans-serif' && 'option-button-selected'}`}
                >
                  Sans-Serif
                </button>
              </div>
            ...
            <div className="option-group">
              ...
              <div className="buttons">
                <button
                  ...
                  className={`option-button ${settings.spellcheck && 'option-button-selected'}`}
                >
                  Enable Spell Check
                </button>
                <button
          ...
          <div className="settings-buttons">
            <div className="option-group">
              <div className="buttons">
                <button className="option-button export">Export</button>
              </div>
            </div>
          </div>
        </div>
